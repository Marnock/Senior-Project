    ...
    public class Kit_ThirdPersonModernPlayerModel : Kit_ThirdPersonPlayerModel
    {
        ...
        public override void SetAnimType(string animType, bool noTrans = false)
        {
            ...
            else
            {
                ...
                {
                    UI.Kit_MainMenu mm = FindObjectOfType<UI.Kit_MainMenu>();
                    if (mm)
                    {
                        game = mm.gameInformation;
                    }
                }
            }
        ...
        public override void PlayWeaponReloadAnimation(string animType)
        {
            if (anim)
            {
                if (animType == "Rifle")
        ...
        IEnumerator ApplyForce()
        {
            ...
            rigidbodies[kpb.ragdollId].AddForceAtPosition(kpb.ragdollForward * kpb.ragdollForce, kpb.ragdollPoint);
